...
//
//ModelResource::skinned_mesh::skinned_mesh(ID3D11Device* device, const char* fbx_filename, int samplingRate, bool triangulate)
//{
...
//}
//
//void ModelResource::skinned_mesh::fetch_meshes(FbxScene* fbx_scene, std::vector<mesh>& meshes)
//{
//    for (const scene::node& node : scene_view.nodes)
//    {
...
//}
//
//void ModelResource::skinned_mesh::fetch_materials(FbxScene* fbx_scene,
...
//}
//
//void ModelResource::skinned_mesh::fetch_skeleton(FbxMesh* fbx_mesh, skeleton& bind_pose)
//{
...
//}
//
//void ModelResource::skinned_mesh::fetch_animations(FbxScene* fbx_scene, std::vector<animation>& animation_clips,
//    float sampling_rate)
//{
...
//}
//
//void ModelResource::skinned_mesh::update_animation(animation::keyframe& keyframe)
//{
...
//}
//
//bool ModelResource::skinned_mesh::append_animations(const char* animation_filename, float sampling_rate)
//{
...
//}
//
//void ModelResource::skinned_mesh::blend_animations(const animation::keyframe* keyframes[2], float factor,
...
//}
//
//void ModelResource::skinned_mesh::create_com_objects(ID3D11Device* device, const char* fbx_filename)
//{
...
//    };
//    create_vs_from_cso(device, "Shader\\lambert_vs.cso", vertex_shader.ReleaseAndGetAddressOf(),
//        input_layout.ReleaseAndGetAddressOf(), input_element_desc, ARRAYSIZE(input_element_desc));
//    create_ps_from_cso(device, "Shader\\lambert_ps.cso", pixel_shader.ReleaseAndGetAddressOf());
//
//    D3D11_BUFFER_DESC buffer_desc{};
...
//}
//
//void ModelResource::skinned_mesh::render(ID3D11DeviceContext* immediate_context,
...
//}
//
//ModelResource::ModelResource(ID3D11Device* device, const char* fbx_filename,
//    int sampling_rate, bool triangulate)
//{
//    skin = std::make_unique<skinned_mesh>(device, fbx_filename, sampling_rate, triangulate);
//
//}
//
