...
//public:
//	ModelResource() {}
//	ModelResource(ID3D11Device* device, const char* fbx_filename,
//		int samplingRate = 0, bool triangulate = false);
//
//	~ModelResource();
//	struct scene
//	{
...
//			{
//				archive(unique_id, name, attribute, parent_index/*, scale, rotate, translate*/);
//			}
//		};
...
//			uint64_t unique_id{ 0 };
//			std::string name;
//			// 'node_index' is an index that refers to the node array of the secne.
//			int64_t node_index{ 0 };
//
...
//			void serialize(T& archive)
//			{
//				archive(unique_id, name, Ka, Kd, Ks, texture_filename);
//			}
//		};
...
//	public:
//		skinned_mesh() {}
//		skinned_mesh(ID3D11Device* device, const char* fbx_filename, int samplingRate = 0, bool triangulate = false);
...
//		void render(ID3D11DeviceContext* immediatea_context,
...
//	scene node;
//	const std::vector<scene::node>& GetNodes() const { return node.nodes; }
//	const std::vector<skinned_mesh::mesh>& GetMeshes() const { return skin->meshes; }
//
//};
//
